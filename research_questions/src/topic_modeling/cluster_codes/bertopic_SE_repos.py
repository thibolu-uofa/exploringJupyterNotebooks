...
if  __name__ == '__main__':
    ...
    dataset = pd.read_csv("headers_jupyter_dataset_top_1000_SE_purpose.csv")
    ...
    df_document_info.to_csv("document_info_SE_purpose.csv")
    ...
    with open('representative_docs_SE_purpose.json', 'w') as json_file:
    ...
    with open("tree_SE_purpose.txt", "w", encoding='utf-8') as f:
      print(tree, file=f)
    ...
    vis_tree.write_html("tree_SE_purpose.html")
    ...
    fig_docs.write_html("docs_SE_purpose.html")
